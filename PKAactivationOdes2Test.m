...
% Test modified PKA activation ODEs
%
% Binding constants from
% https://www.nature.com/articles/s41467-019-11930-2 (Figure 5d)
% multiplied by a factor of 10 (weaker binding) to recaptiulate
% experimental results from
% https://science.sciencemag.org/content/335/6069/712 (Figure 4c)
...
for jj = 1:N
    ...
    A0B0 = 10e-9;  % to test equilibrium, assume [PKA] << [cAMP]
    A1B0 = 0;
    A0B1 = 0;
    A1B1 = 0;
    cAMP = allcAMP(jj);
    ...
    [t,y] = ode23s(@PKAactivationOdes2, tspan, y0, options);
